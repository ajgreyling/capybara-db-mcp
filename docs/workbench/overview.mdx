...
The Workbench is DBHub's built-in web interface for interacting with your database tools. It provides a visual way to execute queries and view request traces without requiring an MCP client.
